                          ...
                          onPressed: (_) async {
                            if (dateTimeFormat(
                              ...
                              _model.editFindUserInfoResponse =
                                  await UsuariosRecord.getDocumentOnce(_model
                                      .editFindGrupoUsuarioResponse!.usuario!);
                              // Find tipo usuario
                              _model.editFindTipoUsuarioResponse =
                                  await TipoUsuarioRecord.getDocumentOnce(
                                      listTileObjetoEntregadoRecord.tipoUsuario!);
                                ...
                                queryBuilder:
                                    (actividadObjetoAEntregarRecord) =>
                                        actividadObjetoAEntregarRecord
                                            ...
                                            .where(
                                              'grupo_actividad',
                                              isEqualTo: widget.grupoActividad,
                                            ),
                              );
                                          ...
                                          _model.deleteObjetosEntregados =
                                            ...
                                            queryBuilder:
                                                (objetoEntregadoRecord) =>
                                                    objetoEntregadoRecord.where(
                                              'asistencia',
                                              isEqualTo: actividadAsistenciaItem
                                                  .reference,
                                            ),
                                          );
